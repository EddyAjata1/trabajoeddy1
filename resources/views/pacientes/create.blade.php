...
<body>
    <div class="container mx-auto">
        <h1 class="font-bold uppercase text-3xl my-5">Registrar paciente</h1>
        <form action="{{ route('pacientes.store') }}" method="post">
            ...
            <div class="text-center">
                <button class="bg-blue-800 text-white pr-4 pl-2 pb-1 pt-1 m-2 hover:bg-red-500 rounded">Guardar Paciente</button>
            </div>
        </form>
    </div>
</body>
